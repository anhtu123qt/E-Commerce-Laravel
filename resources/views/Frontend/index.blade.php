		...
		$(document).ready(function(){
			$('.add-to-cart').click(function(e) {
				...
				$.ajax({
					url:"{{url("add-to-cart")}}",
					type:"POST",
					data:{uid:uid,pid:pid,pimage:pimage,pname:pname,pprice:pprice,_token:_token},
					success:function(data) {
						swal("Tuyệt vời!", "Thêm sản phẩm thành công!", "success");
						$('#cart').html(data);
					}
				});
			})
...
@section('slider_frontend_content')
<div class="container">
	<div class="row">
		<div class="col-sm-12">
